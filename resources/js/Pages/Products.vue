...
<template>
    <AppLayout title="Inventory">
                    ...
                    <div class="px-4 sm:px-6 lg:px-8">
                        <div class="sm:flex sm:items-center">
                            <div class="sm:flex-auto">
                                <h1 class="text-base font-semibold leading-6 text-white">Products</h1>
                                <p class="mt-2 text-sm text-gray-300">A list of all the products that have been added into
                                    the system
                                </p>
                            </div>
                            <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                <button @click="addProductSlide = true" type="button"
        ...
        <AddProductSlide v-show="addProductSlide" @closeSlide="addProductSlide=false" />
