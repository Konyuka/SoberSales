                        ...
                        <ul role="list" class="flex flex-1 flex-col gap-y-7">
                            <li>
                                <ul role="list" class="-mx-2 space-y-1">
                                    ...
                                    <li>
                                        <Link :href="route('inventory.home')"
                                            class="text-gray-400 hover:text-white hover:bg-gray-800 group flex gap-x-3 rounded-md p-2 text-sm leading-6 font-semibold">
                                            <svg class="h-6 w-6 shrink-0" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                                                stroke="currentColor" aria-hidden="true">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div
                    ...
                    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
                        ...
                        <div class="flex items-center gap-x-4 lg:gap-x-6">
                            ...
                            <!-- Profile dropdown -->
                            <div class="relative">
                                <button @click="profileMenu=!profileMenu" type="button" class="-m-1.5 flex items-center p-1.5" id="user-menu-button"
                                ...
                                <div v-if="profileMenu"
                                    ...
                                    <button @click.prevent="logout()"
                                        class="block px-3 py-1 text-sm leading-6 text-gray-900" role="menuitem"
                                        tabindex="-1" id="user-menu-item-1">Sign out</button>
                                </div>
                            </div>
                        </div>
                    </div>
